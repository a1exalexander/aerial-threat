...
const THREAT_SLANG =
  'Сленг: «мопед», «шахед», «герань», «бандероль» — ударні дрони; «бублик», «бублистика», «балістика» — балістика; ' +
...
export const threatType: Text & { criteria: Record<SituationThreatType, string> } = {
  ...
  criteria: {
    shahed: 'Ударні дрони типу Шахед: «шахед», «мопед», «герань»; «бандероль», якщо контекст не каже, що це ракета.',
    jet_shahed: 'Реактивні шахеди: «реактивний шахед», «реактивний мопед», «реактивний».',
    missile: 'Крилаті ракети: «крилата», «ракета».',
